...
export class DocumentService {
  ...
  public getDigitalEvidenceCollectionNotice(): string {
    return `
      The personal information you provide to enroll for access to the Digital Evidence and Disclosure Management System is collected under the authority of  s. 26(a) and 26(c) of
      the Freedom of Information and Protection of Privacy Act (FOIPPA) for the purpose of managing your access to the Digital Evidence and Disclosure Management System. If you have any questions about the collection or use of this information, contact <a href="mailto:${this.config.emails.digitalEvidenceSupport}">${this.config.emails.digitalEvidenceSupport}</a>.
    `;
  }
